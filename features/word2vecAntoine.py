...
s = product_description.product_description.str.cat(sep=" ")
words = s.split()
del s, product_description

# Step 2: Build the dictionary and replace rare wor ds with UNK token.
...
pickle.dump(final_embeddings, open("final_embeddings" + ".p", "wb"))
pickle.dump(reverse_dictionary, open("reverse_dictionary" + ".p", "wb"))
