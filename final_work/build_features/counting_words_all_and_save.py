...
df_train = pd.read_csv('../data/Data_Kaggle/train.csv', encoding="ISO-8859-1")
...
pickle.dump(freq_description, open("../data/pickles/freq_description" + ".p", "wb"))
pickle.dump(doc_freq_description, open("../data/pickles/doc_freq_description" + ".p", "wb"))
...
pickle.dump(freq_attributes, open("../data/pickles/freq_attributes" + ".p", "wb"))
pickle.dump(doc_freq_attributes, open("../data/pickles/doc_freq_attributes" + ".p", "wb"))
